...
//                let image  = UIImage(data: data!)
            let evento = Event(id: evenId, name: eventName as! String, description: eventDescription as! String, photo: nil , place: nil, date: nil , cost: 0.0, photoString: eventImage as? String, tickets: eventTickets as? [String], startDate: evenStart as! String, endDate: nil, country: nil, city: nil, street: nil)
